                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <input type="email" id="email" class="form-control form-control-lg bg-light border-0" placeholder="alex">
                            </div>
                            <div class="mb-3">
                                <label class="form-label small fw-bold text-muted text-uppercase">Lastname</label>
                                <input type="email" id="email" class="form-control form-control-lg bg-light border-0" placeholder="john">
                            </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label small fw-bold text-muted text-uppercase">Email Address</label>
                                <input type="email" id="email" class="form-control form-control-lg bg-light border-0" placeholder="alex@example.com">
                            </div>
                            ...
                            <button type="button" class="btn btn-dark w-100 py-3 my-4 rounded-pill fw-bold shadow" onclick="document.getElementById('step1').classList.add('d-none'); document.getElementById('step2').classList.remove('d-none');">
                                Continue to Verification
                            </button>
                        </form>
                    </div>
                </div>
                <div class="fw-medium my-5 text-center fs-5 text-secondary">I have an Account? <a href="/login" class="text-capitalize text-success" data-link>log in</a></div>
